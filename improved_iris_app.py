...
# S2.3: Perform this activity in Sublime editor after adding the above code. 
# Add title widget
...
# Add a select box in the sidebar with label the 'Classifier' label.
...
# Store the predicted value in the 'species_type' variable accuracy score of model in the 'score' variable. 
